...
if (typedTextElement) {
    const textArray = [ 'Full Stack Developer', 'Power BI Expert','Data Science '];
    let textIndex = 0;
    let charIndex = 0;
...
const GOOGLE_SHEET_URL = 'https://script.google.com/macros/s/YOUR_SCRIPT_ID/usercodeappscript';
